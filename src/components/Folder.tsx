        ...
        >
          ...
          {centerImage && (
            <Image
              ...
              width={56}
              height={56}
              className={`pointer-events-none absolute left-1/2 top-3 -ml-7 z-40 origin-bottom select-none drop-shadow-md transition-all duration-300 ease-in-out ${
                !open ? 'group-hover:translate-y-[13px] group-hover:scale-[0.82]' : ''
              }`}
              style={open ? { transform: 'translateY(13px) scale(0.82)' } : undefined}
            />
          )}
        </div>
      </div>
