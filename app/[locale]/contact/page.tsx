...
import { MdPhone, MdSupportAgent, MdMonetizationOn, MdWarning } from "react-icons/md";
				...
				<div className="card card-bordered w-full min-h-20 bg-inherit border-primary border-4 mt-5">
					<div className="card-body text-center text-gray-400">
						...
						<div className="flex flex-col lg:flex-row justify-center items-center lg:space-x-3 space-y-3 lg:space-y-0">
							<div className={"flex flex-row justify-center items-center space-x-3 tooltip tooltip-warning"} data-tip={t("general-support")}>
								<MdSupportAgent className="w-8 h-8 text-primary" />
								<h3 className="text-xl">hello@mikn.dev</h3>
							</div>
							<div className={"flex flex-row justify-center items-center space-x-3 tooltip tooltip-warning"} data-tip={t("billing-support")}>
								<MdMonetizationOn className="w-8 h-8 text-primary" />
								<h3 className="text-xl">billing@mikn.dev</h3>
							</div>
							<div className={"flex flex-row justify-center items-center space-x-3 tooltip tooltip-warning"} data-tip={t("abuse-reports")}>
