...
export default function SettingsController({ children }: AccButtonProps) {
  ...
  const retract = useConsentStore((state) => state.retract);
        ...
        {open && (
          ...
          >
            <div className="flex flex-col gap-3">
              <Button onClick={retract}>{t("retract")}</Button>
              <div>
                <h3 className="text-primary mb-3 text-md text-center font-bold">Fun Cursors!</h3>
                <div className="grid grid-cols-2 gap-2">
                  <Button disabled={selectedToy === "none"} onClick={() => setSelectedToy("none")}>
                    None
                  </Button>
                  <Button
              ...
              <h3 className="text-primary text-md text-center font-bold">Page Source</h3>
              <a
