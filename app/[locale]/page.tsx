...
export default function Home() {
	...
	return (
		<main className={"scroll-smooth"}>
			<div
				className={
					"flex flex-row justify-between items-center h-screen"
				}
			>
			...
			<div className={""} id={"info"}>
				...
				>
					...
					<div
						className={
							"mt-5 flex flex-row justify-center items-center space-x-5"
						}
					>
						<div className="card card-bordered w-full sm:w-96 min-h-20 bg-inherit border-primary border-4">
					...
					<h3 className={"text-xl text-white mt-3 mb-3"}>
						{t("despite")}
					</h3>
					<div
						className={
